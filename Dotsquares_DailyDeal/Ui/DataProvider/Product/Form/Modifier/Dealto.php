...
class Dealto extends \Magento\Catalog\Ui\DataProvider\Product\Form\Modifier\AbstractModifier
{
    /**
     * @var ArrayManager
     * @since 101.0.0
    ...
    {
        $weightPath = $this->arrayManager->findPath('deal_to', $meta, null, 'children');
