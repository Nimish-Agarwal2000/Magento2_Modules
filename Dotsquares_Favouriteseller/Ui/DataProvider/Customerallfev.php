...
class Customerallfev extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    {	
		...
		$rmaCollection = $this->collection
       	...
       	foreach($rmaCollection as $rma){
            ...
            $aryItem['seller_name'] = $rma->getSellerName();
            $aryItem['seller_email'] = $rma->getSellerEmail();
            
            //$aryItem['link'] = 'https://magento.local/path/to/controller/id/1';
