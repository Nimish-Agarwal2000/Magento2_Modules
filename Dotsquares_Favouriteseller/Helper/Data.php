<?php
namespace Dotsquares\Favouriteseller\Helper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        if ($this->scopeConfig->isSetFlag('marketplace/seller_badge/enable_badge')){
            $template =  'Dotsquares_Sellerbadge::seller/sellerprofile.phtml';
        }
        elseif ($this->scopeConfig->isSetFlag('marketplace/favseller/fevseller_approval')) {
